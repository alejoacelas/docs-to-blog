...
The keys live in `.claude/settings.json` (project) or `/Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/settings.json` (global) — **not** in `.planning/config.json`:
