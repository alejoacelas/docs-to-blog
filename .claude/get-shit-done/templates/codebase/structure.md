...
- Usage: Reference from command with `@/Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
