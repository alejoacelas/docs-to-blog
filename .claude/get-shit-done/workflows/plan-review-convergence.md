...
```bash
INIT=$(node "/Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/get-shit-done/bin/gsd-tools.cjs" init plan-phase "$PHASE")
...
```bash
PHASE_INFO=$(node "/Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
```
...
```bash
node "/Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/get-shit-done/bin/gsd-tools.cjs" state planned-phase --phase "${PHASE}" --name "${phase_name}" --plans "${PLAN_COUNT}"
```
