...
```bash
INIT=$(node "/Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/get-shit-done/templates/spec.md.
