...
<required_reading>
@/Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/get-shit-done/references/ai-frameworks.md
@/Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/agents/gsd-eval-planner.md for instructions.
