...
```
Agent(
  prompt="Read /Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/get-shit-done/templates/VALIDATION.md`
