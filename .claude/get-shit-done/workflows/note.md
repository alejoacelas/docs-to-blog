...
- **Global scope**: `/Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/notes/`)
...
2. Glob `/Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/notes/` — works in any directory
