...
INSTALL_JS_GLOBAL="/Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
