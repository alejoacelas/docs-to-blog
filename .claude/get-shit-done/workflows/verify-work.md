...
<template>
@/Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @/Users/alejo/code/tries/2026-05-12-docs-to-blog/.claude/get-shit-done/workflows/diagnose-issues.md
